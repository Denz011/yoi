...
global.fakefb = {
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"𝙳𝚎𝚗𝚗 𝙱𝙾𝚃","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "𝙳𝚎𝚗𝚗 𝙱𝙾𝚃","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
		...
		global.fimgv = {
            ...
            message: { 
                        ...
                        'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')
                                      ...
                                      // Random Pick Fake
                             let pft = [global.fimg, global.fakeig, global.fimgv, global.fgif]
			                   // Get Random
